...
[assembly: ExportRenderer(typeof(CustomYellowEntry), typeof(CustomYellowEntryRender))]
namespace XamarinCustomControls.Droid.CustomControls
{
    public class CustomYellowEntryRender : EntryRenderer
    {
        public CustomYellowEntryRender(Context context) : base(context)
        {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Entry> e)
        {
            ...
            var color = Android.Graphics.Color.Yellow;
